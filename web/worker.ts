...
function monitorReadiness(engine: EngineHandle): void {
  ...
  const update = (): void => {
    ...
    const [
      ...
      desiredEnvelopeComplete = 0,
      desiredEnvelopeFingerprintLow = 0,
      desiredEnvelopeFingerprintHigh = 0,
      desiredSafetyLeaves = 0,
      desiredHorizonRoots = 0,
      desiredLocusMinimumX = 0,
      desiredLocusMinimumZ = 0,
      desiredLocusMaximumX = 0,
      desiredLocusMaximumZ = 0,
      committedEnvelopeFingerprintLow = 0,
      committedEnvelopeFingerprintHigh = 0,
      committedSafetyLeaves = 0,
      committedSafetyCoverage = 0,
      committedHorizonRoots = 0,
      committedHorizonCoverage = 0,
      committedLocusMinimumX = 0,
      committedLocusMinimumZ = 0,
      committedLocusMaximumX = 0,
      committedLocusMaximumZ = 0,
      presentationTargetXBits = 0,
      presentationTargetYBits = 0,
      presentationTargetZBits = 0,
      presentationGateActive = 0,
      presentationGateStepsLow = 0,
      presentationGateStepsHigh = 0,
      presentationGateFramesLow = 0,
      presentationGateFramesHigh = 0,
    ] = progress;
    const key = [
      resident,
      required,
      ...
      desiredEnvelopeComplete,
      desiredEnvelopeFingerprintLow,
      desiredEnvelopeFingerprintHigh,
      desiredSafetyLeaves,
      desiredHorizonRoots,
      desiredLocusMinimumX,
      desiredLocusMinimumZ,
      desiredLocusMaximumX,
      desiredLocusMaximumZ,
      committedEnvelopeFingerprintLow,
      committedEnvelopeFingerprintHigh,
      committedSafetyLeaves,
      committedSafetyCoverage,
      committedHorizonRoots,
      committedHorizonCoverage,
      committedLocusMinimumX,
      committedLocusMinimumZ,
      committedLocusMaximumX,
      committedLocusMaximumZ,
      presentationTargetXBits,
      presentationTargetYBits,
      presentationTargetZBits,
      presentationGateActive,
      presentationGateStepsLow,
      presentationGateStepsHigh,
      presentationGateFramesLow,
      presentationGateFramesHigh,
    ].join("/");
    if (key !== previous) {
