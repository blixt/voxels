...
VXWP v36 supports one unsharded authoritative world with up to 1,024 admitted player sessions. Spatial
...
still render the other five articulated avatars. Per-player `/v36/world` and `/v36/presence` stream and
