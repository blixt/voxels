...
VXWP v12 supports one unsharded authoritative world with up to 512 admitted player sessions. Spatial
...
still render the other five articulated avatars. Per-player `/v12/world` and `/v12/presence` stream and
