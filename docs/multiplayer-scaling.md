...
VXWP v24 supports one unsharded authoritative world with up to 1,024 admitted player sessions. Spatial
...
still render the other five articulated avatars. Per-player `/v24/world` and `/v24/presence` stream and
