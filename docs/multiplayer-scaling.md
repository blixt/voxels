...
VXWP v15 supports one unsharded authoritative world with up to 512 admitted player sessions. Spatial
...
still render the other five articulated avatars. Per-player `/v15/world` and `/v15/presence` stream and
