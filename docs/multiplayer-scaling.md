...
VXWP v16 supports one unsharded authoritative world with up to 512 admitted player sessions. Spatial
...
still render the other five articulated avatars. Per-player `/v16/world` and `/v16/presence` stream and
