...
VXWP v11 supports one unsharded authoritative world with up to 512 admitted player sessions. Spatial
...
still render the other five articulated avatars. Per-player `/v11/world` and `/v11/presence` stream and
