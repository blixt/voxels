...
VXWP v9 supports one unsharded authoritative world with up to 512 admitted player sessions. Spatial
...
still render the other five articulated avatars. Per-player `/v9/world` and `/v9/presence` stream and
