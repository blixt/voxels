...
VXWP v32 supports one unsharded authoritative world with up to 1,024 admitted player sessions. Spatial
...
still render the other five articulated avatars. Per-player `/v32/world` and `/v32/presence` stream and
