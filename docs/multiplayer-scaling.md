...
VXWP v29 supports one unsharded authoritative world with up to 1,024 admitted player sessions. Spatial
...
still render the other five articulated avatars. Per-player `/v29/world` and `/v29/presence` stream and
