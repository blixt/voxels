...
VXWP v41 supports one unsharded authoritative world with up to 1,024 admitted player sessions. Spatial
...
still render the other five articulated avatars. Per-player `/v41/world` and `/v41/presence` stream and
