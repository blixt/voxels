...
VXWP v8 supports one unsharded authoritative world with up to 512 admitted player sessions. Spatial
...
still render the other five articulated avatars. Per-player `/v8/world` and `/v8/presence` stream and
