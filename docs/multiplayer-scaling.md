...
VXWP v44 supports one unsharded authoritative world with up to 1,024 admitted player sessions. Spatial
...
still render the other five articulated avatars. Per-player `/v44/world` and `/v44/presence` stream and
