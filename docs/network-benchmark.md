...
VXWP v43 preserves the complete immediate 3x3 canonical-chunk vicinity, then reorders unstarted
...
historical result helped motivate deleting that fixed-ring stream in VXWP v43.
