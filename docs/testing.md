...
| Screenshot replay   | `vp run automation -- run replay-screenshot --input=FILE.png`                                           | Reapplies embedded camera, world, environment, render, streaming, and cut metadata                    |
