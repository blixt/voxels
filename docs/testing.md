...
| LOD comparison video | `vp run capture:lod-video`                               | Raw Chromium traversal plus an SSAO-isolated same-pose A/B MP4 delivered to the Desktop      | `target/lod-video/`                 |
