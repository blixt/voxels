...
pub use source::{
    ...
    MeshingSurfaceEnvelope, ModelIdentity, NO_AUTHORED_CONTENT_VERSION,
    PROCEDURAL_SAMPLER_VERSION, PROCEDURAL_SCHEDULER_VERSION, ProceduralWorldSource,
    SourceDeviceRequirement, SurfaceSampleBlockRequest,
...
pub use terrain_page::{
    ...
    TERRAIN_SURFACE_PAGE_CHILDREN, TERRAIN_SURFACE_PAGE_COORD_Y, TerrainClusterTriangle,
    TerrainCanonicalOwnership, TerrainClusterVertex, TerrainColumn, TerrainErrorBounds,
