...
pub use source::{
    ...
    MAX_WORLD_PRODUCT_BATCH, MESHING_HALO_VOXELS, MESHING_SURFACE_CONTRACT_VERSION, MacroBlock,
    MacroBlockBatch, MacroBlockBatchResult, MacroBlockRequest, MacroCoordinateTransform,
    MacroTerrainSource, MeshingEditEnvelope, MeshingHalo, MeshingSurfaceColumn,
    MeshingSurfaceEnvelope, ModelIdentity, NO_AUTHORED_CONTENT_VERSION, PROCEDURAL_SAMPLER_VERSION,
...
pub use terrain_page::{
    SparseVoxelBrickPayload, SteppedSurfaceResidual, TERRAIN_HEIGHTFIELD_BOUNDARY_MIDPOINTS,
    TERRAIN_HEIGHTFIELD_BOUNDARY_SIDES, TERRAIN_PAGE_EDGE_SAMPLES, TERRAIN_PAGE_MAX_CHILDREN,
    TERRAIN_PAGE_MAX_COMPRESSED_BYTES, TERRAIN_PAGE_MAX_LEVEL, TERRAIN_PAGE_MAX_PAYLOAD_BYTES,
    TERRAIN_PAGE_SCHEMA_VERSION, TERRAIN_PAGE_TARGET_COMPRESSED_BYTES,
    TERRAIN_SURFACE_PAGE_CHILDREN, TERRAIN_SURFACE_PAGE_COORD_Y, TerrainCanonicalOwnership,
    TerrainClusterTriangle, TerrainClusterVertex, TerrainColumn, TerrainErrorBounds,
    TerrainHeightfieldGrid, TerrainMaterialCoverage, TerrainMaterialRun, TerrainPageBuildError,
    TerrainPageChild, TerrainPageCodecError, TerrainPageKey, TerrainPageReconstructionError,
    ...
    build_owned_exact_surface_terrain_page, build_sampled_heightfield_terrain_page,
    decode_terrain_page, encode_terrain_page, heightfield_refined_handoff_fingerprints,
