/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 466a0de9cc371a834a98a7d7020bd179)
// Runtime types generated with workerd@1.20260911.1 2026-07-21 nodejs_compat
interface __BaseEnv_Env {
	IDENTITY_ISSUANCE_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	VOXELS_IDENTITY_SIGNING_KEY: string;
	VOXELS_SESSION_SIGNING_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VOXELS_IDENTITY_SIGNING_KEY" | "VOXELS_SESSION_SIGNING_KEY">> {}
}
