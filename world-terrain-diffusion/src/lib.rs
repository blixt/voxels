...
impl TerrainDiffusionConfig {
    ...
    pub fn source_identity(&self) -> Result<WorldSourceIdentity, TerrainDiffusionError> {
        ...
        configuration.update(b"voxels-terrain-diffusion-configuration-v2\0");
        ...
        configuration.update(
            b"uniform-positive-400m-coarse-conditioning;elevation-noise-ratio-0.05;highest-4x4-coarse;max-centred-16x16-latent\0",
        );
