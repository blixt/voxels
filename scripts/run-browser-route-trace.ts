...
function printReportSummary(reportPath: string, report: BrowserRouteTraceReport): void {
  ...
  console.log([
    ...
    `frames over 50ms: ${formatNumber(benchmarkSummary.framesOver50Ms)} (move ${formatNumber(benchmarkSummary.moveFramesOver50Ms)}, settle ${formatNumber(benchmarkSummary.settleFramesOver50Ms)})`,
    ...
    `p95/max LOD chunk slice: ${formatNumber(benchmarkSummary.p95LodChunkMs)}/${formatNumber(benchmarkSummary.maxLodChunkMs)} ms`,
